...
LIST_VEHICLES_RESPONSE = '{"response":[{"color": "", "display_name": null, "id": 321, "option_codes": "MS01,RENA,TM00,DRLH,PF00,BT85,PBCW,RFPO,WT19,IBMB,IDPB,TR00,SU01,SC01,TP01,AU01,CH00,HP00,PA00,PS00,AD02,X020,X025,X001,X003,X007,X011,X013", "user_id": 123, "vehicle_id": 1234567890, "vin": "5YJSA1CN5CFP01657", "tokens": ["x", "x"], "state": "online"}]}'
...
class TeslaApiTestCase(TestCase):
    ...
    def create_vehicle_data():
        ...
        vehicle_data.vehicle = Vehicle.objects.get(id=CURRENT_VEHICLE_ID)
